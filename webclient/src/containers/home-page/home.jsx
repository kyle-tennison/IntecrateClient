      ...
      <div id="home-content">
        ...
        <Fade bottom distance="10%">
          <div className="home-block">
            ...
            <div
              className="home-paragraph half-left"
              style={{ marginTop: "40px" }}
            >
              <strong>You're the designer</strong>
              <br></br>
              Intecrate provides video lessons to help you create your own,
              personal CAD designs. When you're done, we'll connect you with
              world-class manufactures and deliver your custom-fabricated
              aluminum parts for you to assembly.
            </div>
          </div>
          <div className="home-block" style={{ marginTop: "130px" }}>
            ...
            <div
              className="home-paragraph half-right"
              style={{ marginTop: "50px" }}
            >
              <strong>Built by the best</strong>
              <br></br>
              We send your designs out to Reno, Nevada, where our friends at{" "}
              <a href="https://sendcutsend.com" target="_blank">
                SendCutSend
              </a>{" "}
              have 12kW laser-cutters waiting to fabricate your designs at an
          ...
          <div className="home-block" style={{ marginTop: "130px" }}>
            ...
            >
              ...
              <br></br>
              We know that taking this next step in your engineering journey is
              daunting, but we're here to assist you regardless of your skill
              level. We've prepared hundreds of videos and articles to help you
              through every problem you can run into.
            </div>
          </div>
