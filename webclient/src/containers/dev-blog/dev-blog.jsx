  ...
  return (
    <div id="dev-blog">
      ...
      <p>
        ...
        switched gears into react. <br />
        <br />
        For the next month, Intecrate will focus on building the front end. A
        substantial part of the back-end is already built, but we're considering
        translating it into Rust (from Python) before everything grows. <br />
        <br />
        ...
        (Guidelines on contributing have not been established yet.) <br />
        <br />
      </p>
